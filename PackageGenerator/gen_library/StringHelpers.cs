...
public static class StringHelpers
{
    ...
    public static Assembly GetAssembly(this string[] fileNames)
    {
        Console.WriteLine(typeof(StringHelpers).Assembly.Location);
        var c = CodeDomProvider.CreateProvider("CSharp");
        var p = new CompilerParameters(new string[] {
            typeof(StringHelpers).Assembly.Location
        })
        {
